...
if __name__ == "__main__":
    ...
    for i in range(testing_iterations):
        ...
        env.close()       
        image = Image.fromarray(cv2.flip(obs[f'birdview_image'], 0))
        # save image as png 
        image_path = 'code_results/box/LLaVA_ViT/image.png'
        ...
        with open(f'code_results/box/LLaVA_ViT/output_{i}.txt', 'w') as f:
            f.write(completion)
