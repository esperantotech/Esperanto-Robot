...
class Push_Roll_Lift(SingleArmEnv):
    """
    ...
    def __init__(
        ...
        cube_B_pos = [0.05, -0.1, 0.1],
        cube_A_pos = [-0.1, -0.1, 0.1],
        roll_pos = [-0.05, 0, 0.1],
        bar_pos = [0.1, 0.1, 0.1],
    ):
    ...
    def _load_model(self):
        ...
        self.placement_initializer.append_sampler(UniformRandomSampler(
            name="ObjectSamplerC",
            mujoco_objects=self.barA,
            x_range=[self.bar_pos[0], self.bar_pos[0]],
            y_range=[self.bar_pos[1], self.bar_pos[1]],
            rotation=0,
            rotation_axis="z",
            ensure_object_boundary_in_range=False,
            ensure_valid_placement=True,
        ...
        self.placement_initializer.append_sampler(UniformRandomSampler(
            name="ObjectSamplerD",
            mujoco_objects=self.rodA,
            x_range=[self.roll_pos[0], self.roll_pos[0]],
            y_range=[self.roll_pos[1], self.roll_pos[1]],
            rotation=0,
            rotation_axis="y",
            ensure_object_boundary_in_range=False,
        ...
        self.model = ManipulationTask(
            ...
            mujoco_objects=[self.cubeA, self.cubeB, self.barA, self.rodA],
        )
    ...
    def _setup_references(self):
        ...
        self.barA_body_id = self.sim.model.body_name2id(self.barA.root_body)
        self.rodA_body_id = self.sim.model.body_name2id(self.rodA.root_body)
