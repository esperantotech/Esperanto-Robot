...
save_path = f'box/Phi-3-small/{args.objects}'
...
for i in range(testing_iterations):
    ...
    with open(f'box/Phi-3-small/{args.objects}/python_output_{i}.txt', 'w') as f:
        f.write(completion_code)
    with open(f'box/Phi-3-small/{args.objects}/output_{i}.txt', 'w') as f:
